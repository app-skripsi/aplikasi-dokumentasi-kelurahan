<header class="header-global">
    <nav id="navbar-main" aria-label="Primary navigation" class="navbar navbar-main navbar-expand-lg navbar-theme-primary headroom navbar-light navbar-transparent navbar-theme-primary">
        <div class="container position-relative">
            <a class="navbar-brand shadow-soft py-2 px-3 rounded border border-light mr-lg-4" href="<?php echo base_url('/dashboard'); ?>">
                ...
                <div class="navbar-collapse-header">
                    <div class="row">
                        <div class="col-6 collapse-brand">
                            <a href="<?php echo base_url('/dashboard'); ?>" class="navbar-brand shadow-soft py-2 px-3 rounded border border-light">
            ...
            <div class="d-flex align-items-center">
                <button class="btn btn-primary" data-toggle="modal" data-target="#logoutModal">
                    <img src="https://img.freepik.com/free-psd/3d-illustration-person-with-sunglasses_23-2149436188.jpg" class="rounded-circle" alt="User Avatar" style="width: 30px; height: 30px;">
                    <span class="d-block mt-1"><?= session()->get('nama_user'); ?> |
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="text-center">
                    <img src="https://img.freepik.com/free-psd/3d-illustration-person-with-sunglasses_23-2149436188.jpg" class="rounded-circle" alt="User Avatar" style="width: 80px; height: 80px;">
                </div>
